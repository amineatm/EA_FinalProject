...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse register(UserRegisterRequest request) {
        ...
        user.setBio("Hey there! I am using the miu Blog App, my name is "+ request.username()+ ", would love to connect with you.");
        user.setImage("https://avatars.githubusercontent.com/u/84468278");
